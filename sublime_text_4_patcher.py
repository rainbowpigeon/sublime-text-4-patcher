            ...
            self.DB["windows"]["x64"]["base"] = (
                ...
                Patch(
                    ...
                    Sigs(
                        "license_check",
                        Sig(
                            "48 81 ec 00 05 00 00 48 8d ac 24 80 00 00 00 0f 29 b5 70 04 00 00 48 c7 85 68 04 00 00 fe ff ff ff 48 89 cb 48 8d 0d ? ? ? 00 e8 ? ? ? ? 48 8d bd",
                        ),
                        Sig(
                            "48 81 ec ? ? 00 00 48 8d ac 24 80 00 00 00 48 c7 85 ? 04 00 00 fe ff ff ff 48 89 cb 48 8d 0d ? ? ? 00 e8 ? ? ? ? 48 8d bd",
                        ),
                        Sig(
                            "48 81 ec ? ? 00 00 0f 29 b4 24 ? ? 00 00 48 89 ? 48 8d 0d ? ? ? 00 e8 ? ? ? ? 48 8d ? 24 ? ? 00 00",
                        ),
                    ),
                ),
                Patch(
